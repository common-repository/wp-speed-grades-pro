...
Description: The Multifunctional Plugin. Speed Improvement, Security, Tracking, Advanced Tools and more.
...
define( 'WP_SPEED_GRADES_VERSION', '3.0.5');										// Defining plugin version
...
function register_wp_sp_gr_pro_settings() {
	...
	register_setting( 'wp_sp_gr_pro-settings-group4', 'medusa_delayrss' );
	...
	register_setting( 'wp_sp_gr_pro-settings-group4', 'medusa_firss' );
	register_setting( 'wp_sp_gr_pro-settings-group4', 'medusa_gutenberg' );
	...
	register_setting( 'wp_sp_gr_pro-settings-group2', 'medusa_hpcheck' );
	register_setting( 'wp_sp_gr_pro-settings-group2', 'medusa_hpchecknotifyus' );
	register_setting( 'wp_sp_gr_pro-settings-group2', 'medusa_commentnourl' );
	register_setting( 'wp_sp_gr_pro-settings-group2', 'medusa_commentnoclicks' );
	...
	$medusa_delayrss = get_option( 'medusa_delayrss');
	$medusa_firss = get_option( 'medusa_firss');
	$medusa_gutenberg = get_option( 'medusa_gutenberg');
...
<div class="wpspgl-box-wpspgrpro" style="padding-left: 20px; padding-bottom: 70px;">
<h3>Medusa News</h3>
<table style="text-align: center;" width="100%">
<tr>
<td style="text-align: center;">
...
<br/><br/><br/>
<a target="_blank" style="color: #fff; background-color: #00709e; border-color: #005e85; padding: .5rem 1.25rem; text-decoration: none; font-size: .875rem; line-height: 1.3125rem; border-radius: 4px;" href="https://www.wplocalseo.com/solutions/wp-speed-grades-lite-plugin/">SUBSCRIBE</a>
<br/>
<br/>
...
<tr>
<td>
<li>All <strong>Medusa</strong> installations need a License key also known as an API-key. No sensible information is stored. ONLY the Url. This information is automaticaly deleted when you deactivate Medusa</li>
</td>
</tr>
...
<br/><br/>
<div class="clear"></div>
<div style="width: 100%; background-color: #cfddf1!important; padding: 17px; max-width: 1032px;">
<span><b>Activate Tracking</b> and Help Us Improve our Plugin. Also <b>Subsribe</b> to Get Alerts and News about WP Websites and solutions</span> <a style="color: #fff; background-color: #00709e; border-color: #005e85; padding: .5rem 1.25rem; text-decoration: none; font-size: .875rem; line-height: 1.3125rem; border-radius: 4px;" 
...
<div class="wpspgl-box-wpspgrpro" style="padding-left: 20px;">
<h3>Perseus Tracking</h3>
<table class="form-table">

<tr>		
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_hpcheck" name="medusa_hpcheck" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_hpcheck' ) ); ?> />
			<label for="medusa_hpcheck"></label>
</div>
<span>Track Homepage (BETA)</span></th>		
</tr>
...
<div style="background-color: #f5f5f5; padding: 10px; margin-left: -10px; margin-top: 7px; height: 150px;">
<table>
<tr>
<td width="100%" style="vertical-align: top;"><img src="<?php echo plugins_url( '/images/icon-help.png', __FILE__ ); ?>" align="center" style="float: left; padding-right: 15px;"/> <strong>INFO</strong>
<br/>
...
<tr>
<td width="100%">
<li><strong>Track Homepage: </strong>Medusa will start tracking your HomePage Twice Daily. If something suspicious is detected, will send you an Email Alert. ( Email Used for the notification will be the Admin Email ). This is the BETA release of the module. We are still working on this...</li>
...
<div class="wpspgl-box-wpspgrpro" style="padding-left: 20px;">
<h3>Perseus Anti-Spam</h3>
<table class="form-table">

<tr>		
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_commentnourl" name="medusa_commentnourl" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_commentnourl' ) ); ?> />
			<label for="medusa_commentnourl"></label>
</div>
<span>Remove URL Field</span></th>		
</tr>

<tr>		
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_commentnoclicks" name="medusa_commentnoclicks" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_commentnoclicks' ) ); ?> />
			<label for="medusa_commentnoclicks"></label>
</div>
<span>Remove Auto Linking</span></th>		
</tr>

</table>		

<div style="background-color: #f5f5f5; padding: 10px; margin-left: -10px; margin-top: 7px; height: 100px;">
<table>
<tr>
<td width="100%" style="vertical-align: top;"><img src="<?php echo plugins_url( '/images/icon-help.png', __FILE__ ); ?>" align="center" style="float: left; padding-right: 15px;"/> <strong>INFO</strong>
<br/>
...
<tr>
<td width="100%">
<li><strong>Remove URL Field: </strong>Remove the URL Field from the WordPress Comment Form</li>
<li><strong>Remove Auto Linking: </strong>WordPress automatically turns URLs posted in comments into links. The downside to this feature is that it helps spammers publish links in their comments.</li>
...
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_gutenberg" name="medusa_gutenberg" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_gutenberg' ) ); ?> />
			<label for="medusa_gutenberg"></label>
</div>
<span>Disable Gutenberg</span></th>		
</tr>
...
<tr>
<td width="100%">
<li><strong>Disable Gutenberg: </strong>Do you want to disable Gutenberg and keep the classic WordPress editor on your site?</li>
...
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_delayrss" name="medusa_delayrss" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_delayrss' ) ); ?> />
			<label for="medusa_delayrss"></label>
</div>
<span>Delay Posts in RSS Feeds</span></th>		
</tr>

<tr>		
<th scope="row" style="width: 80%; border-style: solid; border-width: 0px 0px 1px 0px; border-color: #f4f4f4;">
<div class="wpsgl-switch">
			<input id="medusa_firss" name="medusa_firss" class="wpsgl-cmn-toggle wpsgl-cmn-toggle-round" type="checkbox" value="1" <?php checked( '1', get_option( 'medusa_firss' ) ); ?> />
			<label for="medusa_firss"></label>
</div>
<span>Add Featured Images to RSS Feed</span></th>		
</tr>
...
<li><strong>Delay Posts in RSS Feeds: </strong>Have you ever published an article accidentally before it was ready to go live? We have all been there.
However, RSS feed readers and email subscribers may already get it in their inbox. Medusa will delay your published posts from appearing in RSS feed for 10 minutes.</li>
<li><strong>Add Featured Images to RSS Feed: </strong>Include the featured images or post thumbnails in the RSS Feed.</li>
</td>
</tr>
</table>
...
// Perseus Anti-Spam
$medusa_commentnourl = get_option('medusa_commentnourl');
$medusa_commentnoclicks = get_option('medusa_commentnoclicks');

// Remove URL
if ( $medusa_commentnourl == 1 ) {
	add_filter('comment_form_default_fields','medusa_remove_comment_fields');
}	

function medusa_remove_comment_fields($fields) {
    unset($fields['url']);
    return $fields;
}

// Remove Autolinks
if ( $medusa_commentnoclicks == 1 ) {
	remove_filter('comment_text', 'make_clickable', 9);
}

// Disable Gutenberg
if ( $medusa_gutenberg == 1 ) {
	// disable for posts
...
function medusa_hp_check_function () {
	//$front_page = wp_remote_get( site_url(), array('timeout' => 60, 'blocking' => true ) );
	$the_url = get_option( 'siteurl' );
	$front_page = file_get_contents ( $the_url );
	//if( is_array( $front_page ) ) {
		$medusa_hpchecktext1 = 'Fatal error';
		$medusa_hpchecktext2 = '403 Forbidden Error';
		$medusa_hpchecktext3 = 'Parse error';
		$medusa_hpchecktext4 = 'Internal Server Error';
		
		$fp_body = $front_page;
		
		$medusa_hpchecktext = '';
		if ( strlen( $front_page ) < 1000 )
		{ 
	        if ( strpos( $fp_body, $medusa_hpchecktext1 ) ) $medusa_hpchecktext = $medusa_hpchecktext1;
			if ( strpos( $fp_body, $medusa_hpchecktext2 ) ) $medusa_hpchecktext = $medusa_hpchecktext2;
			if ( strpos( $fp_body, $medusa_hpchecktext3 ) ) $medusa_hpchecktext = $medusa_hpchecktext3;
			if ( strpos( $fp_body, $medusa_hpchecktext4 ) ) $medusa_hpchecktext = $medusa_hpchecktext4;
	
			$the_email = get_option( 'admin_email' );
			
			// Send to Site Admin Notification

			$subject  = '[MEDUSA]: Alert for ' . $the_url;
			$message  = 'Hello,' . PHP_EOL . PHP_EOL;
			$message .= 'This is a Notification: Your Homepage Size is too Small !' . PHP_EOL;
			if ( $medusa_hpchecktext != '' ) {
				$message .= 'We also discovered the text: "' . $medusa_hpchecktext . '" !' . PHP_EOL;
			}
			$message .= 'Please Check your Website. Is this normal or your Website is Down?' . PHP_EOL;
			
			$message .= PHP_EOL . PHP_EOL;
			$message .= 'Here is what we found on your Homepage:'. PHP_EOL;
			$message .= '--------------------' . PHP_EOL . PHP_EOL;
			$message .= $fp_body;
			$message .= PHP_EOL . PHP_EOL;
			$message .= '----------------------------------------------------------------' . PHP_EOL . PHP_EOL;
			$message .= 'Kind Regards' . PHP_EOL;
			$message .= 'Medusa Multifunctional Plugin. Cool Right?' . PHP_EOL . PHP_EOL;
			$message .= '----------------------------------------------------------------' . PHP_EOL;
			$message .= 'WORDPRESS IS IN OUR DNA : https://www.wplocalseo.com' . PHP_EOL;
			$message .= 'Sponsored by: MOREPRO MARKETING INC. https://morepro.com' . PHP_EOL;
			$message .= '----------------------------------------------------------------' . PHP_EOL;
			$headers  = 'From: '. $the_email . "\r\n" .
			'X-Mailer: PHP/' . phpversion();
			mail($the_email, $subject, $message, $headers);
			//$medusa_hpchecknotifyus = get_option( 'medusa_hpchecknotifyus' );
			//if ( $medusa_hpchecknotifyus == 1 ) {
            //mail('mail@wplocalseo.com', $subject, $message, $headers);			
			//}
		}	
	// }
}

$medusa_hpcheck = get_option( 'medusa_hpcheck');
if ( $medusa_hpcheck == 1 ) {
	if ( ! wp_next_scheduled( 'medusa_check_homepage' ) )
		wp_schedule_event( time(), 'twicedaily', 'medusa_check_homepage' );
	// Do the Schedule
	add_action('medusa_check_homepage', 'medusa_hp_check_function');
}		
...
function medusa_publish_later_on_feed($where) {
...
if ( $medusa_delayrss == 1 ) {
	add_filter('posts_where', 'medusa_publish_later_on_feed');
}	

// Add Featured Image in RSS
function medusa_rss_post_thumbnail($content) {
global $post;
...
if ( $medusa_firss == 1 ) {
	add_filter('the_excerpt_rss', 'medusa_rss_post_thumbnail');
	add_filter('the_content_feed', 'medusa_rss_post_thumbnail');
}	
...
function medusa_wpb_disable_feed() {
wp_die( __('No feed available, Please visit our <a href="'. get_bloginfo('url') .'">homepage</a>!') );
}
 
if ( $wpspgr_norss == 1 ) {
	add_action('do_feed', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_rdf', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_rss', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_rss2', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_atom', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_rss2_comments', 'medusa_wpb_disable_feed', 1);
	add_action('do_feed_atom_comments', 'medusa_wpb_disable_feed', 1);	
}
...
function medusa_deactivation() {
	wp_clear_scheduled_hook( 'medusa_tracking_schedule' );
	wp_clear_scheduled_hook( 'medusa_tracking_schedule_anonymous' );
	wp_clear_scheduled_hook( 'medusa_check_homepage' );
}
...
// UPDATE Messages for New Version
function medusa_prefix_plugin_update_message( $data, $response ) {
	echo '<div class="update-message"><ul>';
	echo '<strong>About Version 3.0.5:</strong>';
	echo '<li><strong>New Security Tool: </strong>HomePage Tracking. Try it now!</li>';
	echo '<li><strong>New Tool: </strong>Deactivate Gutenberg Editor</li>';
	echo '<li><strong>New Anti-Spam Option: </strong>Remove Auto Linking in comments.</li>';
	echo '<li><strong>New Anti-Spam Option: </strong>Remove the URL Field from the Comment Form</li>';
	echo '<li><strong>New Tool: </strong>Delay Posts in RSS</li>';
	echo '<li><strong>New Tool: </strong>Featured Image in RSS</li>';
	echo '</ul></div>';
}
add_action( 'in_plugin_update_message-wp-speed-grades-pro/wpspeed-grades-pro.php', 'medusa_prefix_plugin_update_message', 10, 2 );
